...
class T2TList:
    ...
    def parse(self, allowed_list):
        ...
        newlist = {}
        for hash, data in list(allowed_list.items()):
        ...
        for tracker, hashdata in list(self.list.items()):
            for hash, t2t in list(hashdata.items()):
        ...
        for tracker, hashdata in list(newlist.items()):
            for hash, t2t in list(hashdata.items()):
                if t2t is None:
